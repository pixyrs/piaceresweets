...
const translations: Record<Lang, Dict> = {
  en: {
    ...
    "occasions.3.title": "Corporate",
    "occasions.3.desc": "Branded gifts and event catering for clients and teams.",
    "occasions.4.title": "Gifts",
    "occasions.4.desc": "Hand-tied boxes — a small, memorable thank you.",
    ...
    "faq.1.a": "We recommend at least 5–7 days. For weddings and large events, 3–4 weeks ahead.",
    "faq.2.q": "Is there a minimum order?",
    "faq.2.a": "Boxes start at 12 pieces. Larger occasions usually start at 48 pieces.",
    "faq.3.q": "Do you deliver?",
    "faq.3.a": "Local delivery and pickup are available. Delivery zones depend on order size — message us to confirm.",
    "faq.4.q": "Any allergens to know about?",
    "faq.4.a": "Most of our sweets contain gluten, dairy, eggs and nuts. Tell us about allergies — we'll guide you.",
  ...
  sq: {
    ...
    "occasions.3.title": "Korporata",
    "occasions.3.desc": "Dhurata të brenduara dhe katering për klientë e ekipe.",
    "occasions.4.title": "Dhurata",
    "occasions.4.desc": "Kuti të lidhura me dorë — një falënderim i vogël e i paharrueshëm.",
    ...
    "faq.1.a": "Rekomandojmë të paktën 5–7 ditë. Për dasma dhe evente të mëdha, 3–4 javë përpara.",
    "faq.2.q": "A ka porosi minimale?",
    "faq.2.a": "Kutitë fillojnë nga 12 copë. Për raste më të mëdha zakonisht nga 48 copë.",
    "faq.3.q": "A bëni dorëzim?",
    "faq.3.a": "Ofrojmë dorëzim lokal dhe marrje. Zonat varen nga sasia — na shkruani për konfirmim.",
    "faq.4.q": "A ka alergjene për t'u marrë parasysh?",
    "faq.4.a": "Shumica e ëmbëlsirave kanë gluten, qumësht, vezë dhe arra. Na tregoni për alergjitë — ju udhëzojmë.",
  ...
  sr: {
    ...
    "occasions.3.title": "Korporativno",
    "occasions.3.desc": "Brendirani pokloni i ketering za klijente i timove.",
    "occasions.4.title": "Pokloni",
    "occasions.4.desc": "Ručno vezane kutije — mala, nezaboravna zahvalnica.",
    ...
    "faq.1.a": "Preporučujemo najmanje 5–7 dana. Za venčanja i velike događaje, 3–4 nedelje unapred.",
    "faq.2.q": "Postoji li minimalna porudžbina?",
    "faq.2.a": "Kutije počinju od 12 komada. Za veće prilike obično od 48 komada.",
    "faq.3.q": "Da li dostavljate?",
    "faq.3.a": "Dostupna je lokalna dostava i preuzimanje. Zone zavise od porudžbine — pišite nam za potvrdu.",
    "faq.4.q": "Postoje li alergeni o kojima treba znati?",
    "faq.4.a": "Većina naših slatkiša sadrži gluten, mleko, jaja i orašaste plodove. Javite nam za alergije — vodimo vas.",
