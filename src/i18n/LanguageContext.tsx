...
const translations: Record<Lang, Dict> = {
  en: {
    ...
    "menu.5.name": "Walnut Shells",
    "menu.5.desc": "Buttery walnut-shaped cookies filled with rich chocolate cream",
    "menu.6.name": "Coffee Beans",
    "menu.6.desc": "Delicate cocoa cookies shaped like beans, kissed with espresso",
    ...
    "order.body": " Order via Instagram DM, site or email — orders open Monday to Friday.",
    "order.ig": "Instagram",
    "order.email": "Email",
    "order.site": "Order via site",
    "order.pickup": "Pickup",
    ...
    "form.message": "Tell us anything else",
    ...
    "bajram.title": "A sweet greeting for Eid",
    "bajram.quote": "\"May this Eid fill your home with peace, your heart with love, and your table with sweetness.\"",
  ...
  sq: {
    ...
    "menu.5.name": "Guacka arrash",
    "menu.5.desc": "Biskota me gjalpë në formë arre, të mbushura me krem të pasur çokollate",
    "menu.6.name": "Kokrra kafeje",
    "menu.6.desc": "Biskota delikate kakaoje në formë kokrre, me një prekje espreso",
    ...
    "order.body": " Porosit me Instagram DM, faqe ose email — porositë janë të hapura nga e hëna në të premte.",
    "order.ig": "Instagram",
    "order.email": "Email",
    "order.site": "Porosit përmes faqes",
    "order.pickup": "Marrje",
    ...
    "form.name": "Emri yt",
    "form.email": "Email",
    "form.phone": "Telefoni (opsionale)",
    "form.occasion": "Rasti",
    "form.date": "Data e marrjes",
    "form.message": "Na trego diçka tjetër",
    "form.submit": "Dërgo porosinë",
  ...
  sr: {
    ...
    "menu.4.name": "Breskvice",
    "menu.4.desc": "Sočne breskve, lagani krem, mekani biskvit",
    "menu.5.name": "Oraščići",
    "menu.5.desc": "Putera kolačići u obliku oraha, punjeni bogatim čokoladnim kremom",
    "menu.6.name": "Zrna kafe",
    "menu.6.desc": "Nežni kakao kolačići u obliku zrna, s notom espresa",
    ...
    "order.body": " Poruči preko Instagram DM-a, sajta ili emaila — porudžbine su otvorene od ponedeljka do petka.",
    "order.ig": "Instagram",
    "order.email": "Email",
    "order.site": "Poruči preko sajta",
    ...
    "form.name": "Vaše ime",
    "form.email": "Email",
    "form.phone": "Telefon (opciono)",
    "form.occasion": "Prilika",
    "form.date": "Datum preuzimanja",
    "form.message": "Recite nam još nešto",
    "form.submit": "Pošalji porudžbinu",
    "form.sending": "Šaljem...",
